...
function Form () {
  ...
  return (
   ...
   <Toaster/>
          ...
          <form method='POST' onSubmit={handleSubmit(submitchange)} className='p-6 bg-white rounded-xl flex flex-col gap-4 w-full md:w-3/4 p-8 shadow-xl'>
          
            <div className='flex flex-col'>
              <span className=''></span>
            <label className='text-lg text-customText font-semibold' >Nombre</label>
            <span className='text-danger error'>{errors?.name?.message}</span>
            <input
             {...register('name', { required: true })}
            className='rounded-lg text-lg h-fit w-full p-2 border-2 border-customText text-neutral-800'
            type='text'
            name='name'/>
            </div>
            <div className='flex flex-col'>
              <span className=''></span>
            <label className='text-lg text-customText font-semibold' >Correo</label>
            ...
            <div className='flex flex-col '>
            <label className='text-lg text-customText font-semibold' >Mensaje</label>
            ...
            <Button
            type='submit'
            className='rounded-lg bg-customText px-4 p-2 hover:scale-105 transition-transform duration-400 ease-in-out'
            >Enviar</Button>
            </form>
</>
  )
